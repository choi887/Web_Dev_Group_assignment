            ...
            <x-filter>
                <a href="#"
                    ...
                    <div
                        ...
                        <img src="{{ asset('images/travel.jpg') }}" class="object-cover w-full h-64 md:h-full"
                            alt="Owl image" />
                    </div>
                    ...
                    <div class="flex flex-col justify-between leading-normal p-4 w-full md:w-3/5">
                        <div class="mb-2">
                            ...
                            <div class="text-gray-900 font-bold text-xl mb-2">Can coffee make you a better
                                developer?
                            </div>
                ...
                <a href="#"
                    class="col-span-3 my-4 flex flex-col items-center bg-white rounded-lg shadow md:flex-row w-full hover:bg-gray-100">
                    <div
                        class="relative w-full md:w-2/5 m-0 overflow-hidden rounded-t-lg md:rounded-l-lg md:rounded-tr-none">
                        <img src="{{ asset('images/travel.jpg') }}" class="object-cover w-full h-64 md:h-full"
                            alt="Owl image" />
