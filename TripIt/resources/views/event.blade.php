<x-app-layout>
    ...
    <div>
        ...
        <section class="mt-4">
            ...
            <div class=" mx-auto max-w-screen-xl px-4 lg:px-12 overflow-hidden">
                <!-- Start coding here -->
                <div class="bg-white shadow-md px-10 relative sm:rounded-lg overflow-hidden">
                    <div
                        ...
                        <div
                            ...
                            <button type="button" id="createCategoryModalButton" data-modal-target="createProductModal"
                                data-modal-toggle="createCategoryModal"
                                class="flex items-center justify-center text-black hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 ">
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow sm:p-5">
                    ...
                    <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5">
                        <h3 class="text-lg font-semibold text-gray-900 ">Add a Category</h3>
                        <button type="button"
