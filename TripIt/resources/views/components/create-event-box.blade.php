<div class="rounded-xl border bg-blue-600 shadow-xl border-grey-100">
    <div class="p-8 flex flex-col justify-between">

        <h4 class="font-semibold text-lg text-white leading-tight ">
            Create a new {{ $entityName }} for your Event
        </h4>
        ...
        <div class="w-full flex justify-center pt-4 pr-10">
            <button type="button" id="create{{ $entityName }}ModalButton"
                ...
                class="flex items-center justify-center text-white border border-white hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 ">
