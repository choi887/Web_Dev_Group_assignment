                ...
                <aside>
                    ...
                    <div class="hidden lg:block">
                        <form class="space-y-10 divide-y divide-gray-200">
                                    ...
                                    <div class="space-y-3 pt-6">
                                        <div class="flex items-center">
                                            <input id="category-0" name="category[]" value="hiking" type="checkbox"
                                                class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                            <label for="category-0" class="ml-3 text-sm text-gray-600">Hiking</label>
                                        </div>
                                        <div class="flex items-center">
                            ...
                            <div class="pt-4">
                                <fieldset>
                                    <legend class="block text-sm font-medium text-gray-900">Date
                                    </legend>
                            ...
                            <div class="pt-4">
                                <fieldset>
                                    <legend class="block text-sm font-medium text-gray-900">Food
                                    </legend>
                                    <div class="space-y-3 pt-6">
                                        <div class="flex items-center">
                                            <input id="food-0" name="food[]" value="white" type="checkbox"
                                                class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                            <label for="color-0" class="ml-3 text-sm text-gray-600">Provided</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input id="food-1" name="food[]" value="beige" type="checkbox"
                                                class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                            ...
                            <div class="pt-4">
                                <fieldset>
                                    <legend class="block text-sm font-medium text-gray-900">Price
                                    </legend>
                                    <div class="space-y-3 pt-6">
                                        <div class="flex items-center">
                                            <input id="price-0" name="price[]" value="xs" type="checkbox"
                                                class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                            <label for="price-0" class="ml-3 text-sm text-gray-600">&lt;5,000</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input id="price-1" name="price[]" value="s" type="checkbox"
                                                class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                            <label for="price-1"
                                                class="ml-3 text-sm text-gray-600">5,000-10,000</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input id="price-2" name="price[]" value="s" type="checkbox"
                                                class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                            <label for="price-2"
                                                class="ml-3 text-sm text-gray-600">10,000-25,000</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input id="price-3" name="price[]" value="s" type="checkbox"
                                                class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                            <label for="price-3"
                                                class="ml-3 text-sm text-gray-600">25,000-50,000</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input id="price-4" name="price[]" value="s" type="checkbox"
                                                class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                            <label for="price-4"
                                                class="ml-3 text-sm text-gray-600">50,000-100,000</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input id="price-5" name="price[]" value="s" type="checkbox"
                                                class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                            <label for="price-5"
