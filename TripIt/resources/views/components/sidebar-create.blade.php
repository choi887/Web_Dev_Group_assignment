        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="{{ route('dashboard') }}"
                    class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gradient-to-r from-sky-200 to-sky-300 group">
            ...
            <li>
                <button type="button"
                    class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gradient-to-r from-sky-200 to-sky-300"
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{ route('event.list.admin') }}"
                            class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg group hover:bg-gradient-to-r from-sky-200 to-sky-300">
            ...
            <li>
                <a href="#"
                    class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gradient-to-r from-cyan-200 to-sky-400 group">
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 "
