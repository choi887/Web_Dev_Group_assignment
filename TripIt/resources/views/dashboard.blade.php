                    ...
                    <div class="items-center justify-between p-4 rounded-lg shadow-xl sm:flex  sm:p-6 ">
                        <div class="w-full">
                            ...
                            <p class="flex items-center text-base font-normal text-gray-500 ">
                                <span class="flex items-center mr-1.5 text-md font-semibold text-green-400 ">
                    ...
                    <div class="items-center justify-between p-4 rounded-lg shadow-xl sm:flex  sm:p-6 ">
                        ...
                        <div class="chart-container">
                            <svg class="chart" viewBox="0 0 100 60">
                                <path class="line developer" d="M0,30 Q25,35 50,25 T100,30" />
                                <path class="line designer" d="M0,45 Q25,15 50,35 T100,10" />
                            </svg>
                        </div>
                    </div>
                    <div class="items-center justify-between p-4 rounded-lg shadow-xl sm:flex  sm:p-6 ">
