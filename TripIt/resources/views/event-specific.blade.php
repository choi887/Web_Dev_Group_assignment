<x-header>
    ...
    <section class="bg-white ">
        <div class="py-8 px-4 mx-auto max-w-screen-xl w-full">
            <a href="#" class="my-4 flex flex-col bg-white rounded-lg shadow md:flex-row w-full hover:bg-gray-100">
                <div
                ...
                <div class="flex flex-col justify-between leading-normal p-4 w-full md:w-3/5">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="text-sm self-end text-indigo-600 font-semibold flex items-center hover:underline">
                            More Detail
