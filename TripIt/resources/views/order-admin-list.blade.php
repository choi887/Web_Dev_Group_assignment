                        ...
                        <table class="w-full text-sm text-left text-gray-500 ">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50  ">
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-4">Number Pax</th>
                            ...
                            <tbody>
                                @foreach ($orders as $order)
                                    <tr class="border-b">
                                        ...
                                        <td class="px-4 py-3 max-w-[12rem] font-bold">
                                            {{ $order->item->name }}
                                        </td>
                                        <td class="px-4 py-3 font-bold">
                                            {{ class_basename($order->type) }}
                                        </td>
                                        <td class="px-4 py-3 font-bold {{ $order->text_color }}">
                                            {{ $order->status }}
                                        </td>
                                        <td class="px-4 py-3 font-bold">
                                            {{ $order->user->name }}
